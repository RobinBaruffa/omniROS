...
if("TRUE" STREQUAL "TRUE")
  set(ydlidar_SOURCE_PREFIX /home/user/omniROS/lidar_ws/src/ydlidar-master)
  set(ydlidar_DEVEL_PREFIX /home/user/omniROS/lidar_ws/devel)
  set(ydlidar_INSTALL_PREFIX "")
  set(ydlidar_PREFIX ${ydlidar_DEVEL_PREFIX})
else()
  set(ydlidar_SOURCE_PREFIX "")
  set(ydlidar_DEVEL_PREFIX "")
  set(ydlidar_INSTALL_PREFIX /home/user/omniROS/lidar_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ydlidar' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/user/omniROS/lidar_ws/src/ydlidar-master/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/user/omniROS/lidar_ws/devel/lib;/home/user/omniROS/lidar_ws/devel/lib;/opt/ros/kinetic/lib)
